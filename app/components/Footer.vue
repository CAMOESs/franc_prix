<template>
  <footer class="bg-gradient-to-b from-frost-800 to-frost-900 text-white" > 
  <div class="container mx-auto px-4 py-12">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        <h4 class="font-semibold text-lg mb-4 text-ice-400">Navigation</h4>
        <ul class="space-y-2">
          <li v-for="item in menuItems" :key="item.path">
            <NuxtLink
              :to="item.path"
              class="text-frost-300 hover:text-ice-400 transition-colors duration-300"
            >
              {{ item.label }}
            </NuxtLink>
          </li>
      ...
      <div>
        <h4 class="font-semibold text-lg mb-4 text-ice-400">Suivez-nous</h4>
        <div class="flex space-x-4">
          <a
            ...
            class="w-10 h-10 rounded-full bg-frost-800 flex items-center justify-center hover:bg-ice-600 transition-all duration-300 hover:scale-110"
          >
    ...
    <div class="border-t border-frost-800 mt-8 pt-8 text-center text-frost-400 text-sm">
      ...
      <div class="mt-2 space-x-4">
        ...
        <a href="#" class="hover:text-ice-400 transition-colors">CGV</a>
      </div>
    </div>
  </div>
</footer>
