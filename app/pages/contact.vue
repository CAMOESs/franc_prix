  ...
  <div class="min-h-screen">
    <section class="relative h-[40vh] flex items-center justify-center overflow-hidden">
      <div class="absolute inset-0 z-0">
        <img src="https://images.pexels.com/photos/1591062/pexels-photo-1591062.jpeg?auto=compress&cs=tinysrgb&w=1920"
      ...
      <div class="relative z-10 text-center px-4">
        <h1 class="text-5xl md:text-7xl font-display font-bold text-white mb-4 animate-fade-in">Contactez-nous</h1>
    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div class="space-y-8">
            <div>
              <h2 class="text-3xl md:text-4xl font-display font-bold text-frost-900 mb-6">Envoyez-nous un message</h2>
              <p class="text-frost-600 mb-8">Remplissez le formulaire ci-dessous et notre équipe vous répondra dans les
                plus brefs délais.</p>
            </div>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              ...
              <button type="submit"
                class="w-full px-8 py-4 bg-gradient-to-r from-ice-500 to-ice-600 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95">Envoyer
                le message</button>

              <p v-if="submitted" class="text-green-600 text-center font-medium">Merci ! Votre message a été envoyé avec
                succès.</p>
            </form>
          </div>
          ...
          <div class="space-y-8">
            <div>
              <h3 class="text-2xl font-display font-bold text-frost-900 mb-6">Informations de contact</h3>
            ...
            <div class="bg-gradient-to-br from-frost-50 to-frost-100 rounded-2xl p-8">
              ...
              <div class="space-y-3">
                <div v-for="(schedule, index) in openingHours" :key="index" class="flex justify-between items-center">
            ...
            <div class="rounded-2xl overflow-hidden shadow-lg h-64">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.230752365687!2d2.4008034!3d6.3641754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x102355ca05f27b2b%3A0xa7faca32ec977793!2sFranc%20Prix!5e0!3m2!1sen!2sbj!4v1771066342101!5m2!1sen!2sbj"
    ...
    <section class="py-20 bg-gradient-to-b from-frost-50 to-white">
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
          <h2 class="text-3xl md:text-4xl font-display font-bold text-frost-900 mb-6">Besoin d'aide immédiate ?</h2>
          <p class="text-lg text-frost-600 mb-8">Notre équipe est disponible pour répondre à toutes vos questions</p>
          <!-- <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+2290194961604"
              class="px-8 py-4 bg-gradient-to-r from-ice-500 to-ice-600 text-white rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95">Appelez-nous</a>
            <a href="mailto:contact@francprix.fr"
              class="px-8 py-4 bg-white text-ice-600 border-2 border-ice-500 rounded-full font-semibold text-lg transition-all duration-300 hover:bg-ice-50 hover:scale-105">Envoyez
              un email</a>
          </div> -->
        </div>
      </div>
...
const contactInfo = [
  {
    title: "Adresse",
    content: "9C72+M8F, Rue 560, Cotonou",
    icon:
